...
namespace catch_up_backend.Migrations
{
    ...
    [Migration("20251018214511_removed-points-grades-employeecards")]
    partial class removedpointsgradesemployeecards
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("catch_up_backend.Models.UserProfileModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("catch_up_backend.Models.SchoolingUserPartModel", b =>
                {
                    ...
                    b.HasOne("catch_up_backend.Models.SchoolingUserModel", null)
                        .WithMany()
                        .HasForeignKey("SchoolingUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("catch_up_backend.Models.UserProfileModel", b =>
                {
                    b.HasOne("catch_up_backend.Models.UserModel", "User")
                        .WithOne()
                        .HasForeignKey("catch_up_backend.Models.UserProfileModel", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
